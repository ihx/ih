#ifndef ih_inferno_search_system_h
#define ih_inferno_search_system_h

#include "ih/inferno/search/algorithm.h"
#include "ih/inferno/search/tools.h"

struct ih_inferno_search_system_t;
typedef struct ih_inferno_search_system_t ih_inferno_search_system_t;
...
(ih_inferno_core_score_solution_f score_solution, ih_inferno_core_goal_t goal,
    void *context, ih_case_array_t *initial_solutions,
    ih_inferno_search_algorithm_t algorithm, ih_core_log_t *log);
