...
struct ih_seq_seqx_server_context_t {};
typedef struct ih_seq_seqx_server_context_t ih_seq_seqx_server_context_t;

int main(int argc, char *argv[])
{
  ih_config_disable_if_running_batch_tests(argc, argv);

  ih_seq_seqx_server_context_t custom_server_context;
  ...
  ih_net_engine_iengine_init(&iengine, ih_seq_engine_create,
      ih_seq_engine_destroy, ih_seq_engine_get_handler_for_message,
      ih_seq_engine_maintain, ih_seq_engine_run, ih_seq_engine_start,
      ih_seq_engine_stop);
