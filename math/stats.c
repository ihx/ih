...
{
  *precision = ih_math_stats_get_precision(true_positives, false_positives);
  *recall = ih_math_stats_get_recall(true_positives, false_negatives);
  *f_measure = ih_math_stats_get_f_measure(*precision, *recall,
      recall_weight);
}
