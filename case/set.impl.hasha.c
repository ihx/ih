...
{
  return ih_case_hasha_add((ih_case_hasha_t *) set, object);
}
...
{
  return (ih_case_set_t *) ih_case_hasha_create(iobject,
      IH_CASE_HASHA_SET_TYPE_SET);
}

void ih_case_set_destroy(void *set_object)
{
  ih_case_hasha_destroy(set_object);
}

void *ih_case_set_find(ih_case_set_t *set, void *decoy_object)
{
  return ih_case_hasha_find((ih_case_hasha_t *) set, decoy_object);
}
...
{
  return ih_case_hasha_get_iobject((ih_case_hasha_t *) set);
}

unsigned long ih_case_set_get_size(ih_case_set_t *set)
{
  return ih_case_hasha_get_size((ih_case_hasha_t *) set);
}

void *ih_case_set_iterate_next(ih_case_set_t *set)
{
  return ih_case_hasha_iterate_next((ih_case_hasha_t *) set);
}

void ih_case_set_iterate_remove(ih_case_set_t *set)
{
  ih_case_hasha_iterate_remove((ih_case_hasha_t *) set);
}

void ih_case_set_iterate_start(ih_case_set_t *set)
{
  ih_case_hasha_iterate_start((ih_case_hasha_t *) set);
}
...
{
  ih_case_hasha_remove((ih_case_hasha_t *) set, object);
